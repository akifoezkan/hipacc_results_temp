...
void ccGaussianFilterGKernel(hls::stream<ap_uint<128> > &Output, hls::stream<ap_uint<128> > &Input, int IS_width, int IS_height) {
    ...
    processVECTF<HIPACC_II_TARGET,HIPACC_MAX_WIDTH,HIPACC_MAX_HEIGHT,5,5,HIPACC_PPT,float >(Input, Output, IS_width, IS_height, kernel, BorderPadding::BORDER_UNDEF);
}
