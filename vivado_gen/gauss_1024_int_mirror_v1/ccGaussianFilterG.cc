...
void ccGaussianFilterGKernel(hls::stream<int > &Output, hls::stream<int > &Input, int IS_width, int IS_height) {
    struct ccGaussianFilterGKernelKernel kernel;
    process<HIPACC_II_TARGET,HIPACC_MAX_WIDTH,HIPACC_MAX_HEIGHT,5,5>(Input, Output, IS_width, IS_height, kernel, BorderPadding::BORDER_MIRROR);
}
